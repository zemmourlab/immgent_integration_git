...
#run as: sbatch $SCRIPT_DIR/limma_wrapper_20241217_abT_DN.sh
...
path_to_wd=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_DN

cd $path_to_wd

# no need to sample abT_DN
# path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_DN/igt1_96_abT_DN_20241201.Rds
# output_dir=DGE_limma/20241217
# so_file_name=igt1_96_abT_DN_20241201_sampled_so.Rds
# Rscript $SCRIPT_DIR/limma_sample_seuratobject_20241217.R $path_to_seurat_object $output_dir $so_file_name

output_dir=DGE_limma/20241217
path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_DN/igt1_96_abT_DN_20241201.Rds
tmm_file_name=igt1_96_abT_DN_20241201_tmm.Rds
...
fit_file_name=igt1_96_abT_DN_20241201_fit.Rds
# Rscript $SCRIPT_DIR/limma_fit_20241217_level2.IGTHT.R $path_to_seurat_object $path_to_tmm_object $output_dir $fit_file_name

path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_DN/igt1_96_abT_DN_20241216.Rds
