...
#SBATCH -J abT_CD8aatotalvi              
#SBATCH -o totalviv2_20241113_abT_CD8aa.log
...
#run as: sbatch $SCRIPT_DIR/run_totalvi_wrapper_20241201_abT_CD8aa_rmIGTsample.sh
...
path_to_mudata=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/export_data/igt1_96_20241201_abT_CD8aa.h5mu
prefix=totalvi_20241201_abT_CD8aa_rmIGTsample
batchkey=IGT
