...
#run as: sbatch $SCRIPT_DIR/limma_wrapper_20250109_CD8aa.sh
...
path_to_wd=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/CD8aa

cd $path_to_wd

echo "Sampling seurat object"
path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/CD8aa/igt1_96_CD8aa_20250109.Rds
output_dir=DGE_limma/20250109
so_file_name=igt1_96_CD8aa_20250109_sampled_so.Rds
...
tmm_file_name=igt1_96_CD8aa_20250109_tmm.Rds
...
fit_file_name=igt1_96_CD8aa_20250109_fit.Rds
