...
mdata$organ_simplified = mdata$organ_simplified
# mdata$organ_simplified =  factor(mdata$organ_simplified, levels = names(which(!table( mdata$organ_simplified)==0)))
# mdata$organ_simplified = relevel(mdata$organ_simplified, ref = "spleen")
mdata$organ_simplified[mdata$organ == "colonic epithelium"] = "colon epi"
mdata$organ_simplified[mdata$organ == "lamina propria of mucosa of colon"] = "colon LP"
mdata$organ_simplified[mdata$organ %in% c("epithelium of small intestine","duodenal epithelium","jejunal epithelium","ileal epithelium")] = "small intestine epi"
mdata$organ_simplified[mdata$organ %in% c("lamina propria of small intestine","ileum lamina propria")] = "small intestine LP"
...
umap_df$organ_simplified
umap_df$organ_simplified[umap_df$organ == "colonic epithelium"] = "colon epi"
umap_df$organ_simplified[umap_df$organ == "lamina propria of mucosa of colon"] = "colon LP"
umap_df$organ_simplified[umap_df$organ %in% c("epithelium of small intestine","duodenal epithelium","jejunal epithelium","ileal epithelium")] = "small intestine epi"
umap_df$organ_simplified[umap_df$organ %in% c("lamina propria of small intestine","ileum lamina propria")] = "small intestine LP"
...
p = ggplot(umap_df, aes(x = UMAP_1, y = UMAP_2, color = clusters)) +
  ...
  theme_void() +
  labs(title = "Sample UMAP", x = "UMAP 1", y = "UMAP 2")
