...
metadata = data.frame(so@meta.data[,c("annotation_level2_program", "annotation_level2_program.IGTHT", "IGTHT","organ_simplified","condition_broad", "condition_detailed")])
...
# group1_filter <- expr(annotation_level2 %in% c("CD4.Q")) ##EDIT
# group2_filter <- expr(annotation_level2 %in% c("CD4.G")) #& level2_parent1 == "resting" ##EDIT
# groups = GetGroups(metadata, group1_filter,group2_filter, "annotation_level2.IGTHT")
# nmecontrast = "Q_vs_G" ##EDIT
# group1 = groups[[1]]
# group2 = groups[[2]]
...
group2_filter <- expr(annotation_level2_program %in% c("CD4.G.Th1")) #& level2_parent1 == "resting" ##EDIT
groups = GetGroups(metadata, group1_filter,group2_filter, "annotation_level2_program.IGTHT")
nmecontrast = "RS_vs_Gth1" ##EDIT
group1 = groups[[1]]
group2 = groups[[2]]
contrasts[nmecontrast] = sprintf("(%s)/%s-(%s)/%s", paste(group1, collapse = "+"), length(group1), paste(group2, collapse = "+"), length(group2))
namescontrasts[nmecontrast] = nmecontrast
...
group1_filter <- expr(annotation_level2_program %in% c("CD4.T", "CD4.U")) ##EDIT
group2_filter <- expr(annotation_level2_program %in% c("CD4.G.Th2")) #& level2_parent1 == "resting" ##EDIT
groups = GetGroups(metadata, group1_filter,group2_filter, "annotation_level2_program.IGTHT")
nmecontrast = "TU_vs_Gth2" ##EDIT
group1 = groups[[1]]
group2 = groups[[2]]
contrasts[nmecontrast] = sprintf("(%s)/%s-(%s)/%s", paste(group1, collapse = "+"), length(group1), paste(group2, collapse = "+"), length(group2))
namescontrasts[nmecontrast] = nmecontrast
...
group1_filter <- expr(annotation_level2_program %in% c("CD4.X", "CD4.Y")) ##EDIT
group2_filter <- expr(annotation_level2_program %in% c("CD4.G.Th17")) #& level2_parent1 == "resting" ##EDIT
groups = GetGroups(metadata, group1_filter,group2_filter, "annotation_level2_program.IGTHT")
nmecontrast = "XY_vs_Gth17" ##EDIT
group1 = groups[[1]]
group2 = groups[[2]]
contrasts[nmecontrast] = sprintf("(%s)/%s-(%s)/%s", paste(group1, collapse = "+"), length(group1), paste(group2, collapse = "+"), length(group2))
namescontrasts[nmecontrast] = nmecontrast
...
group1_filter <- expr(annotation_level2_program %in% c("CD4.H", "CD4.I")) ##EDIT
group2_filter <- expr(annotation_level2_program %in% c("CD4.G.Tfhchron")) #& level2_parent1 == "resting" ##EDIT
groups = GetGroups(metadata, group1_filter,group2_filter, "annotation_level2_program.IGTHT")
nmecontrast = "HI_vs_Gthfhchron" ##EDIT
group1 = groups[[1]]
group2 = groups[[2]]
contrasts[nmecontrast] = sprintf("(%s)/%s-(%s)/%s", paste(group1, collapse = "+"), length(group1), paste(group2, collapse = "+"), length(group2))
namescontrasts[nmecontrast] = nmecontrast
