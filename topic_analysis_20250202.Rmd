...
```{r}
so = readRDS(file = "DGE_limma/20250109/igt1_96_withtotalvi20250109_clean_sampled.Rds")
```
...
```{r}
# so$nCount_RNA[1:100] == colSums(so[["RNA"]]$counts)[1:100]
...
20250202_kauto_pe_pl
```{r}
prefix2 = "20250202_kauto_pe_pl"
