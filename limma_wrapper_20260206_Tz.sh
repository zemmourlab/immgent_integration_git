...
#run as: sbatch $SCRIPT_DIR/limma_wrapper_20260206_Tz.sh
...
path_to_wd=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/Tz

cd $path_to_wd

echo "Sampling seurat object"
path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/Tz_igt1_96_withtotalvi20260206_clean.Rds
output_dir=DGE_limma/20260206
so_file_name=Tz_igt1_96_withtotalvi20260206_clean_sampled.Rds
...
tmm_file_name=igt1_96_Tz_20260206_tmm.Rds
...
fit_file_name=igt1_96_Tz_20260206_fit.Rds
