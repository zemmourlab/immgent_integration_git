...
#SBATCH -J mde              
#SBATCH -o mde_incremental_20250109_abT_CD8aa.log
...
#run as: sbatch $SCRIPT_DIR/run_mde_incremental_wrapper_20250109_abT_CD8aa.sh
...
working_dir=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_CD8aa
prefix=20250109_abT_CD8aa
mde_ref_file=totalvi_20241201_abT_CD8aa_rmIGTsample/mde2_nooutliers.csv
totalvi_integrated_file=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/totalvi_20241008_rmIGTsample/latent_abT_CD8aa.csv
cd $working_dir
