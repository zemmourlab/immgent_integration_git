...
Continuation from clustering_DN_igt_1_96.Rmd
...
cd /project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/DN
R
```
...
--> cometsc/20250109/igt1_96_DN_filteredforCometsc.Rds

```{r}
so = readRDS("igt1_96_DN_20250109.Rds")
so_orig = so
...
saveRDS(so, sprintf("%s/igt1_96_DN_filteredforCometsc.Rds", prefix))

```

Heatmap Clusters ADT
```{r}
so = readRDS(sprintf("%s/igt1_96_DN_filteredforCometsc.Rds", prefix))
