...
dir_with_file = "totalvi_20241008_rmIGTsample"
so = AddLatentData(so, latent_file = sprintf("%s/mde.csv",dir_with_file), prefix = "umap_totalvi_20241008_rmIGTsample", calculate_umap = F)
write.table(so[['umap_totalvi_20241006']]@cell.embeddings, file = sprintf("%s/umap.csv",dir_with_file), quote = F, sep = ",", row.names = T, col.names = T)

```

Add Clusters totalvi_20241006/clusters.csv
```{r}
