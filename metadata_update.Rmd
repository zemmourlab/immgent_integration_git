...
# Now directly in annotation_table_2050109.csv but if needed:
# so$annotation_level2_parent1 = "not_applicable"
...
annotl1 = read.table("/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/annotation_table_20250109_withlevel2CD8AB_CD4_gdT_nonconv_CD8aa_DN_DP.csv",header = T, sep = ",", row.names = 1)
all(rownames(annotl1) == colnames(so))
colnames(annotl1)
so$annotation_level1 = annotl1[colnames(so),"level1"]
so$annotation_level2 = annotl1[colnames(so),"level2"]
...
saveRDS(so,"/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/igt1_96_withtotalvi20250109_2.Rds")
