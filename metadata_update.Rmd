...
**Add Clusters e.g. totalvi_20241006/clusters.csv**
```{r}
...
**Add Annotations**
annotation_level1.csv
annotation_level2_XX.csv
```{r}
...
# so$annotation_level2_parent1[so$annotation_level2 %in% c("CD4_cl10", "CD4_cl13", "CD4_cl14", "CD4_cl15", "CD4_cl16", "CD4_cl17", "CD4_cl18", "CD4_cl20", "CD4_cl21", "CD4_cl22", "CD4_cl23", "CD4_cl25", "CD4_cl9", "CD8AB_cl10", "CD8AB_cl11", "CD8AB_cl12", "CD8AB_cl13", "CD8AB_cl14", "CD8AB_cl15", "CD8AB_cl18", "CD8AB_cl20", "CD8AB_cl6", "CD8AB_cl7","treg_cl1", "treg_cl7")] = "activated"
# so$annotation_level2_parent1[so$annotation_level2 %in% c("CD4_cl1", "CD4_cl12", "CD4_cl2", "CD4_cl3", "CD4_cl4", "CD4_cl5", "CD4_cl7", "CD8AB_cl1", "CD8AB_cl2", "CD8AB_cl22", "CD8AB_cl4", "CD8AB_cl5","treg_cl1", "treg_cl7"
# )] = "resting"
...
**Add iNKT and MAIT info**
```{r}
so = readRDS("/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/igt1_96_withtotalvi20241021.Rds")
tcr = read.table(file = "/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/TCR/All.IGTs.Enhanced.Summary.Table.2024-10-11.csv", sep = ",", header = T, quote = F, as.is = T)
so$iNKT = colnames(so) %in% tcr$IGT.cellID[tcr$isNKT]
so$MAIT = colnames(so) %in% tcr$IGT.cellID[tcr$isMAIT]
```
