...
so$annotation_level1 = factor(so_orig$annotation_level1, levels = c("CD8", "CD4", "Treg", "gdT", "CD8aa", "nonconv", "DN", "DP", "thymocyte", "nonT", "remove", "unclear"))
...
**12. Split by lineage**
```{r}
prefix = "igt1_96_withtotalvi20250710_clean.Rds"
so = readRDS(prefix)
