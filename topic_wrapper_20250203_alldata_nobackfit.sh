...
#run as: sbatch $SCRIPT_DIR/topic_wrapper_20250203_alldata_nobackfit.sh
...
output_dir=topic/flashier20250203_alldata_nobackfit
backfit=False

# Rscript $SCRIPT_DIR/topic_flashier_20250203.R $path_to_seurat_object $output_dir
