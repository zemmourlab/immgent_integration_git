...
**Load Metadata**
```{r}
m = read.table("/project/jfkfloor2/zemmourlab/david/immgent/analysis/integration/IGT1_56/Sample_metadata_david_20240324_v3.txt",header = T, sep = "\t")
...
mi = buildGraph(mi, k = 10, d = 30, reduced.dim = "TOTALVI") #d = 30 because 30 dims in TOTALVI
mi = makeNhoods(mi, reduced_dims = "TOTALVI", prop = 0.5, k = 10, d = 30, refined = TRUE) #use same k and d as above

plotNhoodSizeHist(mi) + ggtitle("test") #best to have a distribution peaking between 50 and 100. Otherwise you might consider rerunning makeNhoods increasing k and/or prop. here changed k from 10 to 25
