...
tmm_file_name=igt1_96_20250109_tmm.Rds
...
fit_file_name=igt1_96_20250109_fit.Rds
...
prefix_file_name=Level1
Rscript $SCRIPT_DIR/limma_contrasts_20250121_Level1.R $path_to_seurat_object $path_to_tmm_object $path_to_fit_object $output_dir $prefix_file_name
