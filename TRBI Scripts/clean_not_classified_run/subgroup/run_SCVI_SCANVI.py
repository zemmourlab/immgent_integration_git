#!/usr/bin/env python3
"""This script run SCVI and SCANVI from an AnnData object specifying batch_key and categorical_covariate_keys if needed, """
#author: Odhrán Casey
#date: 12/01/2025
#run_totalvi_v2.py [cwd] [path to anndata .h5ad] [prefix] [batchkey] [categorical_covariate_keys] [corrected_counts] [denoised_data]
...
# Uncomment if already trained - load scvi model
#scvi_model = scvi.model.SCVI.load(prefix+"/scvi_model/", adata=mdata)

print("save latent_scvi.csv"")
...
## Check that no labels have less than 2 counts - avoid creation of mini batches 
