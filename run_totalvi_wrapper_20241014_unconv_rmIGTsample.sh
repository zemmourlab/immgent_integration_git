...
#SBATCH -J unconvtotalvi              
#SBATCH -o totalviv2_20241014_unconv.log
...
#run as: sbatch $SCRIPT_DIR/run_totalvi_wrapper_20241014_unconventional_rmIGTsample.sh
...
path_to_mudata=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/export_data/igt1_96_20241014_unconventional.h5mu
