...
metadata = data.frame(so@meta.data[,c("annotation_level2","annotation_level2_group", "annotation_level2.IGTHT", "IGTHT","organ_simplified","condition_broad", "condition_detailed", "sex")])
...
contrasts = c()
namescontrasts = c()
# for (cl in levels(metadata$annotation_level2_group)[1]) {
#     print(cl)
#     group1_filter <- expr(annotation_level2_group == cl) ##EDIT
#     group2_filter <- expr(!(annotation_level2_group %in% cl) ) #& level2_parent1 == "resting" ##EDIT
