...
#SBATCH -J totalvi              
#SBATCH -o totalviv2_20240527_2.log
...
path_to_mudata=/project/jfkfloor2/zemmourlab/david/immgent/analysis/integration/IGT1_56/adata_tcellonly_nothymus.h5mu
prefix=totalvi_igt1_56_tcellonly_nothymus_igtsampleregressedout
batchkey=IGT
