...
see github immgent_integration_git for latest code
```{r}
SubsetData = function(so = so, to_subset = "resting_CD4") {
    tmp = so[,so$ClusterTOTALVI_Res1 %in% as.character(annot$ClusterTOTALVI_Res1[annot$for_subset == to_subset])]
