...
mypal_level1 = setNames(mypal, unique(tmp$annotation_level1))
mypal_level1 = mypal_level1[!is.na(names(mypal_level1))]

mypal_level2 = setNames(mypal, unique(tmp$annotation_level2))
mypal_level2 = mypal_level1[!is.na(names(mypal_level2))]

mypal_condition_detailed_simplified = setNames(mypal, unique(tmp$condition_detailed_simplified))
...
**factor analysis of sample x proportions? like gene programs?**
```{r}
