...
**Plot top % samples for each cluster**
...
p = ggplot(mdata) + geom_point(aes(CD8_cl26.prop, CD8_cl26.ncells, color = organ_simplified)) + theme_bw() + scale_color_manual(value = mypal)
