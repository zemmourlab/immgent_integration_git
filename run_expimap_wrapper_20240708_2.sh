...
#SBATCH -J expimap              
#SBATCH -o expimap_20240708_2.log
...
prefix=expimap/20240708_2
batchkey=IGT
path_to_signatures=/project/jfkfloor2/zemmourlab/david/immgent/analysis/integration/IGT1_56/Treg/signaturelist20171024.gmt
hvg=2000
alpha_kl=0.1
alpha=0.1
