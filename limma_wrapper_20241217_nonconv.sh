...
#run as: sbatch $SCRIPT_DIR/limma_wrapper_20241217_nonconv.sh
...
# no need to sample nonconv
# path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/nonconv/igt1_96_nonconv_20241201.Rds
# output_dir=DGE_limma/20241217
# so_file_name=igt1_96_nonconv_20241201_sampled_so.Rds
# Rscript $SCRIPT_DIR/limma_sample_seuratobject_20241217.R $path_to_seurat_object $output_dir $so_file_name

output_dir=DGE_limma/20241217
path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/nonconv/igt1_96_nonconv_20241201.Rds
tmm_file_name=igt1_96_nonconv_20241201_tmm.Rds
