...
#SBATCH -J mde              
#SBATCH -o mde_incremental_20250109_nonconv.log
...
#run as: sbatch $SCRIPT_DIR/run_mde_incremental_wrapper_20250109_nonconv.sh
...
working_dir=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/nonconv
prefix=20250109_nonconv
mde_ref_file=totalvi_20241201_nonconv_rmIGTsample/mde2_nooutliers.csv
totalvi_integrated_file=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/totalvi_20241008_rmIGTsample/latent_nonconv.csv
cd $working_dir
