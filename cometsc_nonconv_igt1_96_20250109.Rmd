---
title: "cometsc_nonconv"
output: html_document
date: "2025-01-09"
---

Continuation from clustering_nonconv_igt_1_96.Rmd
...
--> cometsc/20250109/igt1_96_nonconv_filteredforCometsc.Rds

```{r}
so = readRDS("igt1_96_nonconv_20250109.Rds")
so_orig = so
...
saveRDS(so, sprintf("%s/igt1_96_nonconv_filteredforCometsc.Rds", prefix))

```

Heatmap Clusters ADT
```{r}
so = readRDS(sprintf("%s/igt1_96_nonconv_filteredforCometsc.Rds", prefix))
