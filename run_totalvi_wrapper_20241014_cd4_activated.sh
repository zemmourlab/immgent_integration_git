...
#SBATCH -J cd4act              
#SBATCH -o totalvi_20241014_CD4_activated.log
...
#run as: sbatch $SCRIPT_DIR/run_totalvi_wrapper_20241014_cd4_activated.sh
...
path_to_mudata=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/export_data/igt1_96_20241014_CD4_activated.h5mu
prefix=totalvi_20241014_CD4_activated
batchkey=IGT
