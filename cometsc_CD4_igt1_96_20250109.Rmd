...
umap_result = umap(t(so[["ADT"]]@scale.data), n_neighbors = 15, min_dist = 0.1, metric = "euclidean")
so[["umap.panel2"]] = CreateDimReducObject(umap_result, assay = "ADT", key = "umap.panel2")
