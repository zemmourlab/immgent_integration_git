...
sbatch $SCRIPT_DIR/limma_wrapper_20241217_abT_CD8aa.sh
one vs all
```{bash}

```

sbatch $SCRIPT_DIR/limma_wrapper_20240109_CD8aa.sh
one vs all (not miniverse or prolif)
miniverse, prolif, miverse v prolif
```{r}
...
```{r}
setwd("/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_CD8aa/DGE_limma/20241217")
