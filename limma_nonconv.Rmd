...
sbatch $SCRIPT_DIR/limma_wrapper_20241217_nonconv.sh
one vs all
```{bash}
...
```{r}
setwd("/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/nonconv/DGE_limma/20241217")
