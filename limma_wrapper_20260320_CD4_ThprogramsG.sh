...
#run as: sbatch $SCRIPT_DIR/limma_wrapper_20260320_CD4_ThprogramsG.sh
...
cd $path_to_wd
output_dir=DGE_limma/20260320_CD4_GprogramsvsTips
...
path_to_seurat_object=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/CD4/misc_plots/CD4_GHIRSTUXY_igt1_96_withtotalvi20260206_clean_annotation_level2_program.Rds
...
Rscript $SCRIPT_DIR/limma_contrasts_20260320_CD4_ThprogramsG.R $path_to_seurat_object $path_to_tmm_object $path_to_fit_object $output_dir $prefix_file_name
