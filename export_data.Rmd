...
(Update the metadata in seurat object) skip, now its own script metadata_update.Rmd
```{r}
...
Don't make Make h5ad files: weird, doesn't want to save protein names in adata_rna.obsm['protein'].varm..
SO Make h5mu filE INSTEAD!
```{python}
import pandas as pd
...
mudata without ribosomal genes, lncRNA
```{python}
...
CD45.1, CD45.2, Thy1.2 THY1.1.CD90.1 
TCRVA2 TCRVA8.3 TCRVA8.3bis  TCRVB5.1-TCRVB5.2 TCRVB8.1-TCRVB8.2 TCRVG1.1 TCRVG2 TCRVG3
...
mdata.write('/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/igt1_96_20241006_noTCRRiboMitoLncgenes_TCRCongenicproteins.h5mu')
