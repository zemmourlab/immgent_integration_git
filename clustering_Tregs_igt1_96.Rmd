...
######
Transfer labels
Nothing to tranfer because only cells got removed
Just rename prolif, minivers and preT
```{r}
library(RcppAnnoy)
...
table(so_orig$annotation_level2[so_orig$annotation_level1 == "treg"], so$level2_new[colnames(so_orig)[so_orig$annotation_level1 == "treg"]])
