...
conda remove --prefix /project/zemmour/david/envs/scarches_20240424 --all
conda remove --prefix /project/zemmour/david/envs/scarches --all
conda remove --prefix /project/zemmour/david/envs/scarches_test --all
conda remove --prefix /project/zemmour/david/envs/scarches_test2 --all
<!-- conda remove --prefix /project/zemmour/david/envs/scarches_test3 --all -->
conda remove --prefix /project/zemmour/david/envs/scarches_test4 --all
conda remove --prefix /project/zemmour/david/envs/scarches_test8 --all
conda remove --prefix /project/zemmour/david/envs/scarches --all

conda remove --prefix /project/zemmour/david/envs/mrvi_test3 --all
conda remove --prefix /project/zemmour/david/envs/mrvi_test4 --all
conda remove --prefix /project/zemmour/david/envs/mrvi_test5 --all

conda remove --prefix /project/zemmour/david/envs/mrvi_test6 --all
conda remove --prefix /project/zemmour/david/envs/mrvi_test7 --all
conda remove --prefix /project/zemmour/david/envs/mrvi_test8 --all
conda remove --prefix /project/zemmour/david/envs/scvi120_test1 --all

conda remove --prefix /project/zemmour/david/envs/scvi120_test2 --all
conda remove --prefix /project/zemmour/david/envs/scvi120_test3 --all
conda remove --prefix /project/zemmour/david/envs/scvi120_20241003 --all
conda remove --prefix /project/zemmour/david/envs/scvi113_20240525 --all

conda remove --prefix /project/zemmour/david/envs/R_20250227 --all
...
mamba create -p /project/zemmour/david/envs/r443 python=3.10

module load python/anaconda-2022.05
source activate /project/zemmour/david/envs/r443
conda install r-base=4.4.3

conda install conda-forge::r-seurat    #didn't work with CRAN
conda install conda-forge::r-lme4 #didn't work with CRAN
