...
adata = adata[adata.obs['annotation_level1'] == "Treg"]
adata.mod["RNA"].layers["counts"] = adata.mod["RNA"].X.copy()
...
mdata.obs['annotation_level2'] = query_metadata["annotation_level2"].values
...
mdata.obs['annotation_level2'] = query_metadata['annotation_level2'].values
mdata.mod['RNA'].obs['annotation_level2'] = query_metadata['annotation_level2'].values
...
full.obs['annotation_level2'][len(adata.obs_names):] = query_metadata['annotation_level2'].values
#adata.obs['annotation_level2'].values + query_metadata['celltypes'].values
full.obs['clusters/celltypes'] = "NA"
clusters_celltypes = pd.concat([adata.obs['annotation_level2'],query_metadata['annotation_level2']])
