...
#SBATCH -J mde              
#SBATCH -o mde_incremental_20250109_Treg.log
...
#run as: sbatch $SCRIPT_DIR/run_mde_incremental_wrapper_20250109_Treg.sh
...
working_dir=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/Treg
prefix=20250109_Treg
mde_ref_file=totalvi_20241014_Treg_rmIGTsample/mde2.csv
totalvi_integrated_file=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/totalvi_20241008_rmIGTsample/latent_Treg.csv
cd $working_dir
