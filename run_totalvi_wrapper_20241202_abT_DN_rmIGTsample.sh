...
#SBATCH -J abT_DNtotalvi              
#SBATCH -o totalviv2_20241202_abT_DN.log
...
#run as: sbatch $SCRIPT_DIR/run_totalvi_wrapper_20241202_abT_DN_rmIGTsample.sh
...
path_to_mudata=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/export_data/igt1_96_20241202_abT_DN.h5mu
