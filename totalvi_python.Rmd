...
Create muData object: totalvi_igt1_56_allgenes_Treg_20240306/adata.h5mu
```{python}
...
Get corrected count data (for RNA and proteins)
...
mmwrite("totalvi_igt1_56_allgenes_Treg_20240306/counts_corrected.mtx", newcounts_sparse)
...
genes_prot.to_csv("totalvi_igt1_56_allgenes_Treg_20240306/genes.csv", index = False,header=False )

cells = pd.DataFrame(model.adata.obs_names)
cells.to_csv("totalvi_igt1_56_allgenes_Treg_20240306/cells.csv", index = False,header=False )
