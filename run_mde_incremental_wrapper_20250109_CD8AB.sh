...
#SBATCH -J mde              
#SBATCH -o mde_incremental_20250109_CD8AB.log
...
#run as: sbatch $SCRIPT_DIR/run_mde_incremental_wrapper_20250109_CD8AB.sh
...
prefix=20250109_CD8AB
mde_ref_file=totalvi_20241014_CD8AB_rmIGTsample/mde2.csv
totalvi_integrated_file=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/totalvi_20241008_rmIGTsample/latent_CD8AB.csv
cd $working_dir
