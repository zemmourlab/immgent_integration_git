...
so_integrated <- readRDS("/n/groups/cbdm_lab/odc180/ImmgenT_workshop/ImmgenT_freeze_20250109/igt1_104_withtotalvi20250505_downsampled.Rds")
...
## Save as query anndata objecta
SaveH5Seurat(query, paste0(output_dir, "/query.h5seurat"))
Convert(paste0(output_dir, "/query.h5seurat"), dest = "h5ad", raw = FALSE)

## Save as ImmgenT anndata objecta
SaveH5Seurat(so_integrated, paste0(output_dir, "/ImmgenT.h5seurat"))
Convert(paste0(output_dir, "/ImmgenT.h5seurat"), dest = "h5ad", raw = FALSE)
