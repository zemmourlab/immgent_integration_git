...
#SBATCH -J mde              
#SBATCH -o mde_incremental_20250109_abT_DN.log
...
#run as: sbatch $SCRIPT_DIR/run_mde_incremental_wrapper_20250109_abT_DN.sh
...
working_dir=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/abT_DN
prefix=20250109_abT_DN
mde_ref_file=totalvi_20241201_abT_DN_rmIGTsample/mde2_nooutliers.csv
totalvi_integrated_file=/project/zemmour/david/ImmgenT/analysis/data_integration/IGT1_96/totalvi_20241008_rmIGTsample/latent_abT_DN.csv
cd $working_dir
